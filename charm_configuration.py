...
if "SAML_ENTITY_ID" in os.environ:
    ...
    # TODO maybe use env variable DJANGO_BASE_URL from the reverse proxy??
    # How to really set this? Maybe a config option?
    ...
    SOCIAL_AUTH_SAML_ENABLED_IDPS = {
        "saml": {
            ...
            # TODO Do we really this want this hardcoded?
            "attr_user_permanent_id": "email",
        }
    }
    # TODO Create this certificates in Rockcraft if they are really necessary,
